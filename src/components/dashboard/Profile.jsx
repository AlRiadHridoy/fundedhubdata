            ...
            <div className="flex flex-wrap mx-[-15px]">
              <div className="xl:w-3/12 lg:w-3/12 w-full px-[15px]">
                <div className="flex flex-wrap mx-[-15px]">
                  <div className="w-full px-[15px]">
                    <div className="py-[30px] mb-[30px] rounded-[10px] bg-[#F5F9FF] relative z-10 overflow-hidden dark:bg-dark">
                      <div className="author-head text-center md:px-[30px] mb-[20px]">
                        ...
                        <h4 className="text-dark font-semibold 2xl:text-[18px] text-[14px] dark:text-white">
                          mikha dev
                        </h4>
                        <p className="text-dark 2xl:text-[18px] text-[14px] mb-[10px] dark:text-white/70">
                          mikha.dev@gmail.com
                        </p>
                      ...
                      <div className="author-tab">
                        <button
                          className={`w-full 2xl:text-[16px] text-[14px] font-semibold flex items-center 2xl:px-[30px] px-[15px] py-[15px] mb-[16px] gap-4 ${
                            infoToggle === "personal"
                              ? "text-dark/90 bg-all"
                              : ""
                          }`}
                        ...
                        >
                          <FaDiscord className="text-[22px] text-[#7289DA]" />
                          Discord Settings
                        </button>
                      </div>
                    </div>
              ...
              <div className="xl:w-9/12 lg:w-9/12 w-full px-[15px] relative">
                {infoToggle === "personal" ? (
                    ...
                    <div className="content">
                      <div className="author-form">
                        ...
                        <div className="btn mt-6 flex justify-end">
                          <button className="save py-3 px-10 rounded-lg bg-primary text-main-bg  hover:bg-white transition-all duration-200">
                            Save
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="card-wrap">
                    <div className="p-[30px] mb-[30px] rounded-[10px] bg-[#F5F9FF] relative z-10 overflow-hidden flex items-center justify-between gap-[20px] lg:flex-nowrap flex-wrap dark:bg-dark">
