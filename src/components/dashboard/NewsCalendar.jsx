  ...
  return (
    <main className="content-wrapper">
      <div className="calender-header py-[150px] px-[15px] xl:ml-[-20px] text-center">
        ...
        <p className="text-white md:text-[18px] text-[16px] font-normal leading-[1.5]">
        ...
        <div className="dashboard-wrapper">
          <div className="flex flex-wrap mx-[-15px]">
            <div className="w-full px-[15px]">
              <div className="hidden lg:flex bg-white border-1 relative -mt-[55px] gap-3 2xl:px-16 px-8 rounded-md shadow-[0_4px_10px_rgba(64,123,255,0.13)] py-9 justify-evenly dark:bg-dark">
              ...
              <div className="hidden lg:flex px-12 bg-white rounded-md py-8 filterWith mt-[30px] shadow-[0_4px_10px_rgba(64,123,255,0.13)] flex-wrap dark:bg-dark">
                <div className="w-[38%] 2xl:pr-16 pr-8">
                  <h3 className="font-bold text-[#636363] font-rubik text-xl pb-4 dark:text-white">
                    Days
                  </h3>
                  <div className="grid 2xl:grid-cols-[1fr_1fr_1fr] grid-cols-[1fr_1fr] gap-6 text-center">
                    <div className="border border-[#EBEBEB] px-[15px] py-[10px] rounded-[5px] text-dark transition-all duration-300 ease-linear hover:border-primary hover:text-primary cursor-pointer dark:text-white">
                      Sunday
                    </div>
                    <div className="border border-[#EBEBEB] px-[15px] py-[10px] rounded-[5px] text-dark transition-all duration-300 ease-linear hover:border-primary hover:text-primary cursor-pointer dark:text-white">
                      Monday
                ...
                <div className="w-[30%] 2xl:px-16 px-8 2xl:mr-16 mr-8 border-l-[1px] border-r-[1px] border-[#EFEFEF]">
                  ...
                  <div className="grid 2xl:grid-cols-[1fr_1fr] grid-cols-1 gap-6">
                    <label
                      className="flex flex-wrap justify-center items-center px-[10px] py-[10px] border border-[#3b82f6] bg-[#3b82f6]/10 rounded-full cursor-pointer dark:bg-[#3b82f6]"
                      htmlFor="low"
                    >
                      <span className="mr-2 text-dark text-base font-medium shadow-badge dark:text-white">
                        Low
                      </span>
                      <input
                    ...
                    <label
                      className="flex flex-wrap justify-center items-center px-[10px] py-[10px] border border-[#f89b63] bg-[#f89b63]/10 rounded-full cursor-pointer dark:bg-[#f89b63]"
                      htmlFor="medium"
                    >
                      <span className="mr-2 text-dark text-base font-medium shadow-badge dark:text-white">
                        Medium
                    ...
                    <label
                      className="flex flex-wrap justify-center items-center px-[10px] py-[10px] border border-[#e60a16] bg-[#e60a16]/10 rounded-full cursor-pointer dark:bg-[#e60a16]"
                      htmlFor="high"
                    >
                      <span className="mr-2 text-dark text-base font-medium shadow-badge dark:text-white">
                        High
                    ...
                    <label
                      className="flex flex-wrap justify-center items-center px-[10px] py-[10px] border border-primary bg-primary/10 rounded-full cursor-pointer dark:bg-primary"
                      htmlFor="holiday"
                    >
                      <span className="mr-2 text-dark text-base font-medium shadow-badge dark:text-white">
                        Holiday
                ...
                <div className="2xl:w-[22%] w-[28%]">
                  ...
                  <div className="flex flex-wrap gap-6">
                    <label
                      className="flex flex-wrap justify-center items-center px-[30px] py-[10px] border border-[#e60a16] bg-[#e60a16]/10 rounded-full cursor-pointer dark:bg-[#e60a16]"
                    ...
                    <label
                      className="flex flex-wrap justify-center items-center px-[30px] py-[10px] border border-[#ebebeb] bg-[#ebebeb]/10 rounded-full cursor-pointer dark:bg-[#ebebeb]"
                      htmlFor="no-restrictions"
                    >
                      <span className="mr-2 text-dark text-base font-medium shadow-badge dark:text-dark">
                        No Restrictions
                      </span>
                      <input
                        className="w-[14px] h-[14px] cursor-pointer"
              ...
              <div className="mt-[30px] mb-[80px]">
                  ...
                  <div className="table-responsive 2xl:w-full w-[1400px]">
                    <div className="t-head flex border-[1px] border-primary/50 py-3.5 px-2 rounded-md">
                      ...
                      <div className="w-[14%] flex items-center">
                        <h3 className="pr-2 text-dark font-semibold dark:text-white">
                          DATE
                        </h3>
                        <div className="relative cursor-pointer group">
                          ...
                          <div className="absolute bg-gray-900 text-white font-rubik whitespace-nowrap p-2 rounded top-[calc(100%+10px)] left-[50%] -translate-x-1/2 before:absolute before:content-[''] before:w-[10px] before:h-[10px] before:bg-gray-900 before:rotate-45 before:top-[-5px] before:left-[50%] before:translate-x-[-50%] hidden group-hover:block">
                            GMT +6
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="t-body">
                      <div className="t-row flex items-center px-[10px] py-[15px] border border-primary/50">
                        <div className="w-[13%] 2xl:pl-[20px]">
                          <button className="text-dark text-[16px] font-semibold px-[30px] py-[6px] border border-primary bg-primary/10 rounded-full cursor-pointer dark:text-white">
                            Holiday
                          </button>
                        </div>
                        <div className="w-[30%]">
                        ...
                        <div className="w-[13%]">
                          <p className="text-dark text-center dark:text-white"></p>
                        </div>
                        <div className="w-[13%]">
                          <p className="text-dark text-center dark:text-white"></p>
                        </div>
                      ...
                      <div className="t-row flex items-center px-[10px] py-[15px] border border-primary/50 ">
                        <div className="w-[13%] 2xl:pl-[20px]">
                          <button className="text-dark text-[16px] font-semibold px-[30px] py-[6px] border border-[#3b82f6] bg-[#3b82f6]/10 rounded-full cursor-pointer dark:text-white">
                            Low
                          </button>
                        </div>
                        <div className="w-[30%]">
                        ...
                        <div className="w-[13%]">
                          <p className="text-dark text-center dark:text-white">
                            11
                          </p>
                        </div>
                        <div className="w-[13%]">
                      ...
                      <div className="t-row flex items-center px-[10px] py-[15px] border border-primary/50 !border-l-[8px] !border-l-[#e60a16] !bg-[#e60a16]/10">
                        <div className="w-[13%] 2xl:pl-[20px]">
                          <button className="text-dark text-[16px] font-semibold px-[30px] py-[6px] border border-[#e60a16] bg-[#e60a16]/10 rounded-full cursor-pointer dark:text-white">
                            High
                          </button>
                        </div>
                        <div className="w-[30%]">
                          <p className="text-dark dark:text-white">CPI m/m</p>
                        </div>
                        <div className="w-[15%]">
                          <div className="inline-flex items-center px-[10px] py-[5px] bg-white rounded-[5px]">
                            <img
                ...
                <div className="t-navigation flex items-center justify-end mt-[40px]">
                  <button className="inline-block text-center w-[45px] h-[48px] text-dark text-[16px] font-semibold bg-[#f1f1f1] rounded-[5px] ml-[10px]">
                    <svg
                      className="inline-block fill-dark"
                      width="7"
                      height="15"
                      viewBox="0 0 7 15"
                      fill="none"
                  ...
                  <button className="inline-block text-center w-[45px] h-[48px] text-white text-[16px] font-semibold bg-primary rounded-[5px] ml-[10px]">
                    1
                  </button>
                  <button className="inline-block text-center w-[45px] h-[48px] text-dark text-[16px] font-semibold bg-[#f1f1f1] rounded-[5px] ml-[10px]">
                    2
