...
import { author, mainLogo, tringle } from "../../ui/images";
...
export default function MobileSideNav({ props }) {
  ...
  return (
    <div className="wrapper relative left-0 right-0 top-0 bottom-0 z-[999] mt-[100px]">
      <aside
        className={`mobile-nav pt-[70px] lg:hidden w-[60%] h-full fixed z-[999] top-0 bottom-0 bg-main-bg transition-all duration-500  ${
    ...
    `}
      >
        ...
        {/* triangle */}
        <img
          className="triangle absolute bottom-[10%] -right-[2%] h-[90rem] w-[90rem] rotate-[-20deg] opacity-[0.2]"
          src={tringle}
          alt="tringle"
        />
        {/* triangle */}
        <img
          className="triangle absolute top-[10%] -left-[70%] w-[90rem] rotate-[-20deg] opacity-[0.3]"
          src={tringle}
          alt="tringle"
        />
      </aside>
