...
import { mainLogo, shadow } from "../ui/images";
...
export default function Navbar() {
  ...
  window.onscroll = () => {
    if (window.scrollY > 2) setScrolled(true);
  ...
  return (
    <>
      <header
        className={`z-50 fixed left-0 right-0  transition-all duration-300 border-b border-transparent py-2 sm:py-4 ${
          scrolled ? "bg-main-bg/80 backdrop-blur-3xl" : ""
        }`}
      >
            ...
            <nav className="nav-links text-white font-thin flex justify-center items-center">
              <ul className="hidden md:flex gap-6 justify-center items-center text-sm">
                ...
                <li className="relative">
                  <Link
                    to="/login"
                    className="flex justify-center items-center font-codeProBold text-main-bg bg-primary rounded-[0.7rem] w-[9rem] h-8 pt-[0.15rem]"
                  >
                    Client Area
                  </Link>
                  ...
                  {/* Shadow */}
                  <img
                    className={`shadow absolute -left-[60%]  min-w-[20rem] -bottom-12 h-8 z-10 opacity-[1] ${
                      scrolled ? "hidden" : ""
                    }`}
                    src={shadow}
                    alt=""
          ...
          <div className="wrapper">
            ...
            <ul className="flex flex-col justify-start text-sm mt-6">
              ...
              <li className="flex mt-4 pl-6">
                <a
                  href="#"
                  className="flex justify-center items-center font-codeProBold text-main-bg bg-primary rounded-lg w-32 h-8 pt-[0.15rem]"
                >
                  Client Area
                </a>
              </li>
