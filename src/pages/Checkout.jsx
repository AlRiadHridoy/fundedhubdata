...
import { applePlay, btcPay, googlePay, tick, tringle } from "../ui/images";
  ...
  return (
    <>
      ...
      <section className="py-32 lg:py-44 relative">
        ...
        {/* triangle */}
        <img
          className="triangle absolute -top-[30%] -right-[10%]  w-[60rem] rotate-[20deg] opacity-[0.2]"
          src={tringle}
          alt="tringle"
        />
        {/* triangle */}
        <img
          className="triangle absolute -bottom-[5%] -right-[30%]  w-[50rem] rotate-[80deg] opacity-[0.2]"
          src={tringle}
          alt="tringle"
        />
        {/* triangle */}
        <img
          className="triangle absolute bottom-[90%] md:-top-[2%] -left-[40%]  w-[50rem] rotate-[-80deg] opacity-[0.25]"
          src={tringle}
          alt="tringle"
        />
        ...
        {/* triangle */}
        <img
          className="triangle sm:hidden absolute  top-[5%] -left-[60%]  w-[50rem] rotate-[-45deg] opacity-[0.15]"
          src={tringle}
          alt="tringle"
        />
        {/* triangle */}
        <img
          className="triangle sm:hidden absolute  top-[35%] -left-[60%]  w-[40rem] rotate-[-100deg] opacity-[0.1]"
          src={tringle}
          alt="tringle"
        />
        {/* triangle */}
        <img
          className="triangle sm:hidden absolute  top-[60%] -left-[60%]  w-[30rem] rotate-[-70deg] opacity-[0.18]"
          src={tringle}
          alt="tringle"
        />
        {/* Mobile */}
        {/* triangle */}
        <img
          className="triangle sm:hidden absolute  top-[10%] -right-[60%]  w-[50rem] rotate-[-45deg] opacity-[0.15]"
          src={tringle}
          alt="tringle"
        />
        {/* triangle */}
        <img
          className="triangle sm:hidden absolute  top-[35%] -right-[60%]  w-[40rem] rotate-[-100deg] opacity-[0.1]"
          src={tringle}
          alt="tringle"
        />
        {/* triangle */}
        <img
          className="triangle sm:hidden absolute  top-[60%] -right-[60%]  w-[30rem] rotate-[-70deg] opacity-[0.18]"
          src={tringle}
          alt="tringle"
        />
      </section>
